...
const getTarefas = async () => {
  const response = await fetch("https://parseapi.back4app.com/classes/Tarefa", {
    method: "GET",
    headers: {
      "X-Parse-Application-Id": "dx2xVzHi7Fklc2QRqxkjjDvGMnAXa9OJad6TmIQm",
      "X-Parse-REST-API-Key": "c7JmmBLGo7Z344XeIcUEIgpPLAvS4bLuScqJtpqS",
    },
  });
      ...
      await fetch(
        `https://parseapi.back4app.com/classes/Tarefa/${tarefa.objectId}`,
        {
          ...
          headers: {
            ...
            "dx2xVzHi7Fklc2QRqxkjjDvGMnAXa9OJad6TmIQm",
            "X-Parse-REST-API-Key": "c7JmmBLGo7Z344XeIcUEIgpPLAvS4bLuScqJtpqS",
...
/*
curl -X POST \
-H "X-Parse-Application-Id: dx2xVzHi7Fklc2QRqxkjjDvGMnAXa9OJad6TmIQm" \
-H "X-Parse-REST-API-Key: c7JmmBLGo7Z344XeIcUEIgpPLAvS4bLuScqJtpqS" \
-H "Content-Type: application/json" \
-d "{ \"descricao\":\"A string\",\"concluida\":true }" \
